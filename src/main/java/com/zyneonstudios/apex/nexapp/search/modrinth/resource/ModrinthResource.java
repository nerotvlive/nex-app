package com.zyneonstudios.apex.nexapp.search.modrinth.resource;
...
import com.zyneonstudios.apex.nexapp.search.modrinth.search.facets.ModrinthEnvironmentType;
...
public class ModrinthResource {
    ...
    public ModrinthResource(String id_or_slug) {
        ...
        json = NEXApplication.getInstance().getFastGson().fromJson(GsonUtility.getFromURL(url), JsonObject.class);
        ...
        if (!gameVersions.isEmpty()) {
            ...
            for (JsonElement element : gameVersions) {
                try {
                    ...
                    NEXApplication.getLogger().err("[Minecraft] Couldn't parse game version: " + e.getMessage());
                }
            }
            String[] gV;
            try {
                ...
                gV = null;
                NEXApplication.getLogger().err("[Minecraft] Couldn't parse game versions: " + e.getMessage());
            }
        ...
        if (!categories.isEmpty()) {
            ...
            for (JsonElement element : categories) {
                try {
                    ...
                    NEXApplication.getLogger().err("[Minecraft] Couldn't parse category: " + e.getMessage());
                }
            }
            String[] c;
            try {
                ...
                c = null;
                NEXApplication.getLogger().err("[Minecraft] Couldn't parse categories: " + e.getMessage());
            }
            this.categories = c;
        } else {
        ...
        if (!additionalCategories.isEmpty()) {
            ...
            for (JsonElement element : additionalCategories) {
                try {
                    ...
                    NEXApplication.getLogger().err("[Minecraft] Couldn't parse additional category: " + e.getMessage());
                }
            }
            String[] c;
            try {
                ...
                c = null;
                NEXApplication.getLogger().err("[Minecraft] Couldn't parse additional categories: " + e.getMessage());
            }
        ...
        if (!loaders.isEmpty()) {
            ...
            for (JsonElement element : loaders) {
                try {
                    ...
                    NEXApplication.getLogger().err("[Minecraft] Couldn't parse loader: " + e.getMessage());
                }
            }
            String[] l;
            try {
                ...
                l = null;
                NEXApplication.getLogger().err("[Minecraft] Couldn't parse loaders: " + e.getMessage());
            }
            this.loaders = l;
        } else {
            this.loaders = null;
        ...
        if (!versions.isEmpty()) {
            ...
            for (JsonElement element : versions) {
                try {
                    ...
                    NEXApplication.getLogger().err("[Minecraft] Couldn't parse version: " + e.getMessage());
                }
            }
            String[] v;
            try {
                ...
                v = null;
                NEXApplication.getLogger().err("[Minecraft] Couldn't parse versions: " + e.getMessage());
            }
            this.versions = v;
        } else {
            this.versions = null;
    ...
    public ModrinthResourceVersion getLatestVersion(boolean unstable, boolean unlisted) {
        try {
            ...
            NEXApplication.getLogger().err("[Minecraft] Couldn't get latest pack version: " + e.getMessage());
        }
        return null;
    }
}