package com.zyneonstudios.apex.nexapp.search.curseforge.search;
...
public class CurseForgeSearch {
    ...
    public JsonObject search() {
        try {
            ...
            return NEXApplication.getInstance().getFastGson().fromJson(CurseForgeIntegration.accessAPI(searchRequest), JsonObject.class);
        } catch (Exception e) {
            NEXApplication.getLogger().err("[Minecraft] Could not search through CurseForge: " + e.getMessage());
            return null;
        }
    }
