package com.zyneonstudios.apex.nexapp.search.zyndex.local;
...
public class LocalInstance {
    ...
    private boolean fullscreen = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftFullscreen();
    private int width = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftWindowWidth();
    private int height = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftWindowHeight();
    private int memory = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftMemory();
    private ArrayList<String> jvmArgs = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftJVMArgs();
    private ArrayList<String> envArgs = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftEnvArgs();
    private ArrayList<String> preLaunchHook = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftPreLaunchCommands();
    private ArrayList<String> onLaunchHook = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftOnLaunchCommands();
    private ArrayList<String> onExitHook = NEXApplication.getInstance().getLocalSettings().getDefaultMinecraftOnExitCommands();
