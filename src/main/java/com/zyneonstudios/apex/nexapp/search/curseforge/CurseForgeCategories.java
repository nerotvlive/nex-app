...
public class CurseForgeCategories {
    ...
    public static void init() {
        JsonArray data = NEXApplication.getInstance().getFastGson().fromJson(CurseForgeIntegration.accessAPI("https://api.curseforge.com/v1/categories?gameId=432"), JsonObject.class).getAsJsonArray("data");
