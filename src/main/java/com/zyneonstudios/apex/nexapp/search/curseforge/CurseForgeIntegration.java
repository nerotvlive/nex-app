package com.zyneonstudios.apex.nexapp.search.curseforge;
...
import com.zyneonstudios.apex.nexapp.search.curseforge.resource.CurseForgeResourceVersion;
...
public class CurseForgeIntegration {
    ...
    public static void installModpack(File installDir, int projectId, int versionId) {
        ...
        File tempDir = new File(NEXApplication.getInstance().getWorkingPath(), "temp");
        ...
        if (unzip(download.getAbsolutePath(), curseForgePackPath)) {
            ...
            if (index.exists()) {
                    ...
                    try {
                        ...
                        for (JsonElement file_ : files) {
                            ...
                            try {
                                ...
                                NEXApplication.getLogger().err("Cannot download file \"" + path + file.getFileName() + "\" for curseforge pack \"" + project.getName() + "\": " + e.getMessage(), false);
                            }
                ...
                NEXApplication.getLogger().err("Couldn't find CurseForge manifest json file: " + index.getAbsolutePath());
            }
        }
