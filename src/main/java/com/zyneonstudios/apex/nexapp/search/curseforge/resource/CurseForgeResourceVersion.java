package com.zyneonstudios.apex.nexapp.search.curseforge.resource;
...
public class CurseForgeResourceVersion {
    ...
    public CurseForgeResourceVersion(int modId, int fileId) {
        ...
        this.json = NEXApplication.getInstance().getFastGson().fromJson(CurseForgeIntegration.accessAPI(url), JsonObject.class).getAsJsonObject("data");
