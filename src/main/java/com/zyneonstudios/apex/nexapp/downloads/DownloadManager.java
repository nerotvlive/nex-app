...
import com.zyneonstudios.apex.nexapp.main.NexusRunner;

import java.util.HashMap;
import java.util.UUID;

/**
 * The {@code DownloadManager} class is responsible for managing downloads within the NEX App.
...
public class DownloadManager {
     ...
     */
    public DownloadManager(NEXApplication application) {
